...
import { ButtonGreenShort } from "./Button";
    ...
    <div className="bg-black md:my-[4.6rem] p-4 text-center justify-center items-center w-full">
      ...
      <div className="mt-24 w-full flex justify-center items-center">
        <div className="w-[60%]">
          ...
          <h1 className="text-white text-[3.3rem] font-bold pb-4">
          ...
          <ButtonGreenShort text="Start your free trial" />
          ...
          <p><a href="#" className="underline text-gray-300 mt-4">VIEW CHANNELS IN YOUR AREA →</a></p>
        </div>
      </div>
    </div>
  );
